...
$string['errorgettingvalidatedvideosfailed'] = 'Getting course {$a} validated videos failed.';
...
$string['eventgettingopenveocoursevideosfailed'] = 'Getting course OpenVeo videos failed';
